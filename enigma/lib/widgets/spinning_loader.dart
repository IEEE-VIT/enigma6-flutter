...
class SpinningLoader extends StatefulWidget {
	...
	SpinningLoader({this.color1 = Colors.deepOrangeAccent, this.color2 = Colors.yellow, this.color3 = Colors.lightGreen});

	@override
	_SpinningLoaderState createState() => _SpinningLoaderState();
}

class _SpinningLoaderState extends State<SpinningLoader> with TickerProviderStateMixin {
